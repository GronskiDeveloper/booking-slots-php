...
> 🇵🇱 **Praca AI-first (PL).** Ten silnik zbudowałem z Claude Code — algorytm overlapa i design value-object po mojej stronie (matematyka rezerwacji nie znosi off-by-one), autoload/composer/docblocki po stronie AI. Podział pracy człowiek/AI, weryfikacja i znane pułapki: [CLAUDE.md](CLAUDE.md). Konfiguracja agenta review: [.claude/commands/verify-slot-math.md](.claude/commands/verify-slot-math.md).
>
